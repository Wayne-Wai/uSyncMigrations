...
{
    public static IUmbracoBuilder AddMigrationsClientApi(this IUmbracoBuilder builder)
    {
        ...
        builder.Services.Configure<SwaggerGenOptions>(opt =>
        {
            ...
            {
                Title = "uSync Migrations Client Backoffice API",
                Version = "1.0",
            ...
            opt.OperationFilter<uSyncMigrationsClientOperationSecurityFilter>();
        });
...
public class uSyncMigrationsClientOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
{
...
public class CustomOperationHandler : OperationIdHandler
{
    ...
    {
        return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("uSync.Migrations.Client.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
    }
