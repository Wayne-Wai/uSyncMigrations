...
dotnet build ..\src\uSync.Migrations.Core\uSync.Migrations.Core.csproj -c $env
dotnet build ..\src\uSync.Migrations.Client\uSync.Migrations.Client.csproj -c $env
dotnet build ..\src\uSync.Migrations.Migrators\uSync.Migrations.Migrators.csproj -c $env
dotnet build ..\src\uSync.Migrations\uSync.Migrations.csproj -c $env

""; "##### Packaging"; "----------------------------------" ; ""

dotnet pack ..\src\uSync.Migrations.Core\uSync.Migrations.Core.csproj -c $env -o $outFolder /p:$buildParams
dotnet pack ..\src\uSync.Migrations.Client\uSync.Migrations.Client.csproj -c $env -o $outFolder /p:$buildParams
dotnet pack ..\src\uSync.Migrations.Migrators\uSync.Migrations.Migrators.csproj -c $env -o $outFolder /p:$buildParams
dotnet pack ..\src\uSync.Migrations\uSync.Migrations.csproj -c $env -o $outFolder /p:$buildParams
